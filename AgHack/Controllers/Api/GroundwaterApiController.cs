...
namespace AgHack.Controllers.Api
{
    ...
    public class GroundwaterApiController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetStations()
        {
            ...
            {
                return StatusCode(500, new { message = "取得地下水測站資料時發生錯誤", error = ex.Message });
            }
        }
        ...
        public async Task<IActionResult> GetStation(int id)
        {
            try
            {
                ...
                if (station == null)
                {
                    return NotFound(new { message = "找不到指定的地下水測站" });
                }
            ...
            [FromQuery] int pageSize = 100)
        {
            ...
            {
                return StatusCode(500, new { message = "取得地下水監測資料時發生錯誤", error = ex.Message });
            }
        }
        ...
        public async Task<IActionResult> GetItems()
        {
            ...
            {
                return StatusCode(500, new { message = "取得地下水監測項目資料時發生錯誤", error = ex.Message });
            }
        }
            ...
            [FromQuery] DateTime? endDate = null)
        {
            ...
            {
                return StatusCode(500, new { message = "取得地下水統計資料時發生錯誤", error = ex.Message });
            }
        }
    }
}